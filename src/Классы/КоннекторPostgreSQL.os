...
Процедура Сохранить(ОбъектМодели, Сущность) Экспорт
	...
	// Выданный СУБД идентификатор возвращает сама вставка. Отдельный запрос за ним нельзя было
	// бы считать верным: между вставкой и чтением вклинивается чужая вставка, и объект получил бы
	// не свой идентификатор.
	ТекстВозврата = ?(
