...
Процедура Сохранить(ОбъектМодели, Сущность) Экспорт
	...
	ИдентификаторНеЗадан = НЕ ЗначениеЗаполнено(ЗначениеИдентификатора);
	...
	Если КолонкиТаблицы.Количество() = 1 И ОбъектМодели.Идентификатор().ГенерируемоеЗначение
		И ИдентификаторНеЗадан Тогда
