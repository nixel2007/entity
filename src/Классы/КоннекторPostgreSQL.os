...
Функция ОписаниеСоединения() Экспорт
	Возврат СтрокиСоединения.ОписаниеСервера("postgresql", СтрокаСоединенияКоннектора, ПортПоУмолчанию());
КонецФункции

// Порт сервера PostgreSQL, если в строке соединения он не указан.
//
// Возвращаемое значение:
//   Число - Стандартный порт PostgreSQL.
//
Функция ПортПоУмолчанию()
	Возврат 5432; // BSLLS:MagicNumber-off
КонецФункции
