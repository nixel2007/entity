...
Процедура ИнициализироватьТаблицу(ОбъектМодели) Экспорт
	...
	ИнтерфейсКоннекторов.ИнициализироватьТаблицу(ЭтотОбъект, ОбъектМодели);
...
Процедура Удалить(ОбъектМодели, Сущность) Экспорт
	...
	ИнтерфейсКоннекторов.Удалить(ЭтотОбъект, ОбъектМодели, Сущность);
...
Функция НайтиСтрокиВТаблице(ОбъектМодели, Знач Отбор) Экспорт
	...
	Возврат ИнтерфейсКоннекторов.НайтиСтрокиВТаблице(ЭтотОбъект, ОбъектМодели, Отбор);
...
Процедура УдалитьСтрокиВТаблице(ОбъектМодели, Знач Отбор) Экспорт
	...
	ИнтерфейсКоннекторов.УдалитьСтрокиВТаблице(ЭтотОбъект, ОбъектМодели, Отбор);
...
Функция ВыполнитьЗапрос(ТекстЗапроса) Экспорт
	...
	Возврат ИнтерфейсКоннекторов.ВыполнитьЗапрос(ЭтотОбъект, ТекстЗапроса);
...
Функция ПолучитьОписаниеВнешнегоКлюча(ОбъектМодели, КолонкаМодели) Экспорт
	...
	Возврат ИнтерфейсКоннекторов.ПолучитьОписаниеВнешнегоКлюча(ОбъектМодели, КолонкаМодели);
