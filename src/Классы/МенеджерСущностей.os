...
// ПулСоединенийСБД - Выдает контекстам исполнения отдельные коннекторы: через него идут все обращения к БД.
Перем ПулСоединений;
...
//     следующий контекст ждет освобождения, но не дольше предела ожидания - иначе получает ошибку.
