...
Процедура Сохранить(Сущность) Экспорт
	...
	ХранилищеСущностей = ПолучитьХранилищеСущностей(ТипСущности);
	ХранилищеСущностей.Сохранить(Сущность);
КонецПроцедуры
...
Функция Получить(ТипСущности, Отбор = Неопределено) Экспорт
	...
	ХранилищеСущностей = ПолучитьХранилищеСущностей(ТипСущности);
	Возврат ХранилищеСущностей.Получить(Отбор);
...
Функция ПолучитьОдно(ТипСущности, Знач Отбор = Неопределено) Экспорт
	ХранилищеСущностей = ПолучитьХранилищеСущностей(ТипСущности);
	Возврат ХранилищеСущностей.ПолучитьОдно(Отбор);
КонецФункции
...
Процедура Удалить(Сущность) Экспорт
	ТипСущности = ТипЗнч(Сущность);
	ХранилищеСущностей = ПолучитьХранилищеСущностей(ТипСущности);
	ХранилищеСущностей.Удалить(Сущность);
КонецПроцедуры
...
Процедура Закрыть() Экспорт
	...
	ХранилищаСущностей.Закрыть(ТипЗнч(Коннектор), СтрокаСоединенияКоннектора, ПараметрыКоннектора);
...
Функция ПолучитьХранилищеСущностей(ТипСущности) Экспорт
	...
	ХранилищеСущностей = ХранилищаСущностей.Получить(ОбъектМодели, Коннектор, СтрокаСоединенияКоннектора);
