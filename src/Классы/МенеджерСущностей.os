...
Перем ПулСоединений;
// Сколько соединений пул придерживает для переиспользования.
...
//   РРазмерПулаСоединений - Число - Сколько соединений пул придерживает для переиспользования.
//     Нулевой размер отключает переиспользование: каждая транзакция открывает новое соединение
//     и закрывает его по завершении. Собственное соединение контекст получает в любом случае.
//
...
//   Неопределено - Текущий контекст не начинал транзакцию.
//
