...
Процедура ЗаполнитьКолонки()
	...
	Для Каждого Свойство Из ТаблицаСвойств Цикл
		...
		ТипСсылки = РаботаСАннотациями.ПолучитьЗначениеПараметраАннотации(АннотацияКолонка, "ТипСсылки");
...
Процедура ЗаполнитьПодчиненныеТаблицы()
	...
	Для Каждого Свойство Из ТаблицаСвойств Цикл
		...
		ДанныеОПодчиненнойТаблице.ТипТаблицы = РаботаСАннотациями.ПолучитьЗначениеПараметраАннотации(АннотацияПодчиненнаяТаблица, "Тип");
		
		ТипЭлемента = РаботаСАннотациями.ПолучитьЗначениеПараметраАннотации(АннотацияПодчиненнаяТаблица, "ТипЭлемента");
