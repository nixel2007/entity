...
//
Функция ПреобразоватьКоллекциюКСущностям(ИсходнаяКоллекция, РодительскаяСущность) Экспорт
	...
	Если ТипКоллекции = Тип("Массив") Тогда
		...
		Для сч = 0 По ИсходнаяКоллекция.ВГраница() Цикл
			...
			УстановитьЗначениеКолонкиВПоле(СущностьЭлемент, "ref", РодительскаяСущность);
			УстановитьЗначениеКолонкиВПоле(СущностьЭлемент, "key", сч);
			УстановитьЗначениеКолонкиВПоле(СущностьЭлемент, "value", Значение);
	...
	ИначеЕсли ТипКоллекции = Тип("Структура") Тогда
		...
		Для Каждого ЭлементКоллекции Из ИсходнаяКоллекция Цикл
			...
			УстановитьЗначениеКолонкиВПоле(СущностьЭлемент, "ref", РодительскаяСущность);
			УстановитьЗначениеКолонкиВПоле(СущностьЭлемент, "key", ЭлементКоллекции.Ключ);
			УстановитьЗначениеКолонкиВПоле(СущностьЭлемент, "value", ЭлементКоллекции.Значение);
...
Функция ПреобразоватьКоллекциюСущностейККоллекции(КоллекцияСущностей, ДанныеОКолонке) Экспорт
	// @unstable
...
Функция СоответствиеТиповМоделиОписанийТипов()
	...
	Карта.Вставить(ТипыКолонок.Массив, Новый ОписаниеТипов("Массив"));
	Карта.Вставить(ТипыКолонок.Структура, Новый ОписаниеТипов("Структура"));
