...
Функция ПолучитьСтрокуСоединения() Экспорт
	Возврат мСтрокаСоединения;
КонецФункции

Функция ПолучитьПараметрыКоннектора() Экспорт
	Возврат мПараметрыКоннектора;
КонецФункции
...
Процедура Открыть(СтрокаСоединения, ПараметрыКоннектора) Экспорт
	мСтрокаСоединения = СтрокаСоединения;
	мПараметрыКоннектора = ПараметрыКоннектора;
	Открыт = Истина;
КонецПроцедуры
