...
//
// Класс описывает интерфейс коннектора: реализации объявляют его аннотацией
// &Реализует("АбстрактныйКоннектор") и могут дополнительно объявить НаблюдаемыйКоннектор.
//
&Интерфейс
