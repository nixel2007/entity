...
//
//  Возвращаемое значение:
//   Массив - Массив, элементами которого являются "Соответствия" со значениями колонок найденного объекта.
//
Функция ПолучитьЗначенияКолонок(ОбъектМодели, Отбор = Неопределено) Экспорт
