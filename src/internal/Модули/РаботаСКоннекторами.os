...
Функция Получить(Коннектор, ОбъектМодели, ПулСущностей, Отбор = Неопределено) Экспорт
	...
	Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
		...
		Для Каждого ПодчиненнаяТаблица Из ПодчиненныеТаблицы Цикл
			...
			Если ПодчиненнаяТаблица.ТипТаблицы = ТипыПодчиненныхТаблиц.Массив 
				И Не ТипыКолонок.ЭтоПримитивныйТип(ПодчиненнаяТаблица.ТипЭлемента) Тогда
				...
				Для Каждого ЭлементКоллекции Из ЗначениеКолонки Цикл
					ЭлементКоллекции = ХранилищеСущностейСсылки.ПолучитьОдно(ЭлементКоллекции);	
				КонецЦикла;
