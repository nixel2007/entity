...
Процедура Сохранить(Коннектор, ОбъектМодели, ПулСущностей, Сущность) Экспорт
	...
	ТипыРасширяемыеТаблицами = Коннектор.ТипыРасширяемыеТаблицами();
...
Функция Получить(Коннектор, ОбъектМодели, ПулСущностей, Отбор = Неопределено) Экспорт
	...
	Если ТипЗнч(Отбор) = Тип("Соответствие") Тогда
		...
		Для Каждого КлючИЗначение Из Отбор Цикл
			...
			ЭлементОтбора = Новый ЭлементОтбора(Колонка.ИмяКолонки, ВидСравнения.Равно, КлючИЗначение.Значение);
			ПередаваемыйОтбор.Добавить(ЭлементОтбора);
		КонецЦикла;
	ИначеЕсли ТипЗнч(Отбор) = Тип("Массив") Тогда
		Для Каждого ЭлементОтбора Из Отбор Цикл
			...
			ЭлементОтбора = Новый ЭлементОтбора(Колонка.ИмяКолонки, ЭлементОтбора.ВидСравнения, ЭлементОтбора.Значение);
			ПередаваемыйОтбор.Добавить(ЭлементОтбора);
		КонецЦикла;
