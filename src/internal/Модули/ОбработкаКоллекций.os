...
Функция ПолучитьОбъектМоделиДляПодчиненнойТаблицы(РодительскийОбъектМодели, ПодчиненнаяТаблица) Экспорт
	...
	// Колонки модели только для чтения, но этот объект модели только что создан и еще никому не отдан.
	КолонкиОбъектаМодели = ОбъектМоделиЭлементКоллекции.Колонки();
