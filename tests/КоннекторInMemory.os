...
Процедура СущностьМожетЗаписатьСебя() Экспорт
	...
	МенеджерСущностей = Новый МенеджерСущностей(Новый ИсточникДанных("Тесты", Тип(ТипКоннектора)));
...
Процедура РаботаСИменованнымПолем() Экспорт
	// Дано
	МенеджерСущностей = Новый МенеджерСущностей(Новый ИсточникДанных("Тесты", Тип("КоннекторInMemory")));
