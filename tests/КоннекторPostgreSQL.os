...
Процедура ПередЗапускомТеста() Экспорт
	...
	Хост = ПолучитьПеременнуюСредыИлиЗначение("POSTGRES_HOST", "localhost");
	Порт = ПолучитьПеременнуюСредыИлиЗначение("POSTGRES_PORT", "5432");
	Пользователь = ПолучитьПеременнуюСредыИлиЗначение("POSTGRES_USERNAME", "postgres");
	Пароль = ПолучитьПеременнуюСредыИлиЗначение("POSTGRES_PASSWORD", "postgres");
	ИмяБД = ПолучитьПеременнуюСредыИлиЗначение("POSTGRES_DATABASE", "postgres");
...
Функция ПолучитьПеременнуюСредыИлиЗначение(ИмяПеременной, ЗначениеПоУмолчанию)
...
Процедура УдалитьТаблицыВБазеДанных()
