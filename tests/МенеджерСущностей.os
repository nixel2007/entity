...
Процедура ПередЗапускомТеста() Экспорт
	...
	МенеджерСущностей.ДобавитьСущностьВМодель(Тип("СущностьСоВсемиТипамиКолонок"));
...
Процедура ПолучитьСущность() Экспорт
	...
	ПолученнаяСущность = МенеджерСущностей.Получить(Тип("СущностьСоВсемиТипамиКолонок"), 1);
