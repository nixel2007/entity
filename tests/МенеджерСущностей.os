...
Процедура ПолучитьСущности() Экспорт
	...
	Ожидаем.Что(ПолученнаяСущность.МассивСсылок[0].Целое, "ПолученнаяСущность.МассивСсылок содержит идентификатор зависимой сущности").Равно(ЗависимаяСущность.Целое);
