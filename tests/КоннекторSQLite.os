...
Процедура ПолучитьЗначенияКолонокСущности() Экспорт
	...
	Ожидаем.Что(ЗначенияКолонок.Получить("Структура"), "ЗначенияКолонок.Массив проинициализировано структурой").ИмеетТип("Структура");
	Ожидаем.Что(ЗначенияКолонок.Получить("Массив").Количество(), "ЗначенияКолонок.Массив имеет корректное количество элементов").ИмеетДлину(ЗависимыйМассив.Количество());
	Ожидаем.Что(ЗначенияКолонок.Получить("Структура").Количество(), "ЗначенияКолонок.Структура имеет корректное количество элементов").ИмеетДлину(ЗависимаяСтруктура.Количество());
КонецПроцедуры
