...
Функция ПрогнатьТесты()
	...
	ПутьКОтчетуJUnit = ОбъединитьПути(ТекущийСценарий().Каталог, "..", "shippable", "testresults");
...
Функция ПрогнатьФичи()
	...
	ПутьОтчетаJUnit = ОбъединитьПути(ТекущийКаталог(), "shippable", "testresults", "bdd-log.xml");
