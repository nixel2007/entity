...
* референсная реализация полнофункционального коннектора к SQLite и упрощенного коннектора к файлам JSON.
...
* <a href="#header">entity - OneScript Persistence API</a>
  ...
  * <a href="#annotations">Система аннотаций для сущностей</a>
    ...
    * <a href="#annotation-ignor-colunm">ИгнорироватьКолонку</a>
  ...
  * <a href="#library-structure">Структура библиотеки</a>
    ...
    * <a href="#library-structure-entity-connector-json">КоннекторJSON</a>
...
&ИгнорироватьКолонку
Перем СлужебнаяПеременная Экспорт;    // Переменная игнорируется и не будет создана в таблице.
...
<a id="annotation-ignor-column" />

### ИгнорироватьКолонку

> Применение: необязательно

Аннотация `ИгнорироватьКолонку` используется для игнорирования экспортной переменной.
